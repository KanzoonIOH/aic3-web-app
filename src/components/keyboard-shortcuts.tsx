...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
    {
        title: "Navigation",
        shortcuts: [
            { keys: ["g", "d"], seq: "d", to: "/admin/dashboard", label: "Go to Dashboard" },
            { keys: ["g", "c"], seq: "c", to: "/admin/chat", label: "Go to Chat" },
            { keys: ["g", "k"], seq: "k", to: "/admin/knowledges", label: "Go to Knowledges" },
            { keys: ["g", "m"], seq: "m", to: "/admin/mcps", label: "Go to MCPs" },
            { keys: ["g", "t"], seq: "t", to: "/admin/tags", label: "Go to Tags" },
            { keys: ["g", "l"], seq: "l", to: "/admin/logs", label: "Go to Message Log" },
            { keys: ["g", "a"], seq: "a", to: "/admin/audit-logs", label: "Go to Audit Log" },
            { keys: ["g", "u"], seq: "u", to: "/admin/members", label: "Go to Members" },
            { keys: ["g", "e"], seq: "e", to: "/admin/api-keys", label: "Go to API Keys" },
            { keys: ["g", "s"], seq: "s", to: "/admin/global-config", label: "Go to Global Config" },
        ],
    },
    {
        title: "General",
